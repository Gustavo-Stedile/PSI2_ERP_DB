...
public class controleEstoque {
    ...
    public controleEstoque getInstance(){
    ...
    // READ PARA PLANEJAMENTO, PRODUÇÃO, VENDAS e NOTA FISCAL
    /*
      Esse trecho permite aos módulos listados acima criarem caixas de seleção
      com produtos e especies e seus ids, além de consultar produtos e especies.
    */
    ...
    // //////////////////////////////////////////
    // CRUD SOMENTE NECESSÁRIO
    
    /*
      O trecho a seguir permite que os Módulos de Produção e Venda
      criem movimentações de entrada e saída.
    */
